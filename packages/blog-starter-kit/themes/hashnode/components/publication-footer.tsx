...
function PublicationFooter(props: any) {
	...
	return (
		<footer className="blog-footer-area -mt-px border-t  px-5 py-10 text-center text-slate-800 dark:border-slate-800 dark:bg-black dark:text-slate-500 md:px-10 md:py-12 lg:py-20">
			{imprint && (
