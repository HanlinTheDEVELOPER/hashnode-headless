...
export const Header = (props: Props) => {
	...
	return (
		<header className="blog-header relative z-50 w-full border-b border-black/10 bg-white bg-opacity-70 dark:border-white/10 dark:bg-slate-900 dark:bg-opacity-70">
			<div className="container mx-auto mt-2 h-full px-2 md:px-4 2xl:px-10">
				<div className="relative z-40 flex h-full flex-row items-center justify-between pb-2 pt-2">
					<div className="ml-2 flex flex-row items-center py-1 ">
						<div className="block">
					...
					<div className={twJoin('flex flex-row items-center', '  dark:text-white')}>
						<div
							className="relative hidden h-full flex-row items-center justify-center overflow-hidden  text-base md:flex"
